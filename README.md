# 🧠 Deep Learning: Fundamentals & Network Architecture
> **Assignment:** Comprehensive analysis of tensor operations and basic neural network structures.

This repository contains a collection of 17 Google Colab notebooks executed and documented to demonstrate a fundamental understanding of Deep Learning mechanics. Each notebook includes full execution outputs and a corresponding video walkthrough explaining the logic and results.

---

## 📋 Project Overview
The goal of this assignment is to master the building blocks of modern AI, focusing on:
* **Tensor Operations:** Manipulation, shapes, and mathematical foundations.
* **Basic Architectures:** Implementation of linear layers, activations, and loss functions.
* **Execution & Analysis:** Verifying outputs and explaining code-block logic.
...
| 07 | Probability for Deep Learning 2 | [📄 View](https://colab.research.google.com/drive/1modN-zBUEUPV260zY8YE4sRbtPX6w2kB?authuser=1#scrollTo=m4Ew39cuZR40) | [🎥 Watch](https://www.youtube.com/watch?v=OHBxoAmmi3A&feature=youtu.be) |
...
| 17 | Advanced Jax| [📄 View](https://colab.research.google.com/drive/1vz5TnnuSeVPxgOJ3AH35aM1oNI32jvWF) | [🎥 Watch](https://www.youtube.com/watch?v=biZJT0iwUjA) |

---

## 🛠️ Requirements & Environment
To run these notebooks locally or in your own Drive:
1. Python 3.8+
2. PyTorch or TensorFlow (as specified in individual notebooks)
